...
App = {
  ...
  initContract: function () {
    ...
    App.contracts.asset = new web3.eth.Contract(
      abi,
      "0x6e3B6851896407032C0c65131afCea8555a2A30d"
    );
          ...
          if (!error) {
            ...
            if (state == 0) {
              ...
              $("#resultPropFunc1").html(
                '<a href="#" id="btn-PropApprove" class="btn btn-primary" style="font-size: 15px; font-weight: bold; border-radius: 8px; border: none; padding: 5px 15px; transition: 0.3s; color: #212529; background-color: transparent; border: 3px solid #212529;">Approve</a>'
              );
              $("#resultPropFunc2").html(
                '<a href="#" id="btn-PropReject" class="btn btn-primary" style="font-size: 15px; font-weight: bold; border-radius: 8px; border: none; padding: 5px 15px; transition: 0.3s; color: #212529; background-color: transparent; border: 3px solid #212529;">Reject</a>'
              );
              $(".sec1").html("");
              $(".sec2").html("");
              $(".sec3").html("");
                ...
                function (error, result) {
                  if (!error) {
                    if (
                      ...
                      $(".sec1").html(
                        '<form action="#" id ="PropReqChangeform"><div class="form-group"><label style="font-size: 20px;">Request Change of Ownership</label><input type="text" class="form-control" id="PropReqChange" name="PropReqChange" placeholder="Enter New Owner Address" style="font-size: 15px; border-radius: 8px;"></div></form><button type="submit"  class="btn btn-primary" id="btn-PropReqChange"  form="form1" value="Submit" style="font-size: 15px; font-weight: bold; border-radius: 8px; border: none; padding: 5px 15px; transition: 0.3s; color: #212529; background-color: transparent; border: 3px solid #212529;">Request</button>'
                      );
                      $(".sec3").html(
                        '<form action="#" id="PropValChangeform"><div class="form-group"><label style="font-size: 20px;">Change Property Value/Price</label><input type="text" class="form-control" id="PropValChange" name="PropValChange" placeholder="Enter New Value/Price" style="font-size: 15px; border-radius: 8px;"></div></form><button type="submit"  class="btn btn-primary" id="btn-PropValChange"  form="form1" value="Submit" style="font-size: 15px; font-weight: bold; border-radius: 8px; border: none; padding: 5px 15px; transition: 0.3s; color: #212529; background-color: transparent; border: 3px solid #212529;">Change</button>'
                      );
                    } else {
                      App.contracts.asset.methods.checkSuperAdmin(accounts[0]).call(
                        ...
                        function (error, results) {
                          if (!error) {
                            if (results) {
                              $(".sec2").html(
                                '<label style="font-size: 20px;">Accept Change of Ownership</label><button type="submit"  class="btn btn-primary" id="btn-PropAcptChange" value="Submit" style="font-size: 15px; font-weight: bold; border-radius: 8px; border: none; padding: 5px 15px; transition: 0.3s; color: #212529; background-color: transparent; border: 3px solid #212529;">Accept</button>'
                              );
                            } else console.log("Not Super");
                          } else console.error(error);
                        }
                        );
                    }
